...
class DataBatchGenerator:
    ...
    def __init__(self, args: dict, mode: str, op_list: List, const_list: List):
        ...
        print( "DataBatchGenerator.init()数据加载" )
    ...
    def _init_data(self, instances, mode):
        ...
        for instance in instances:
            ...
            print("运行到这里"+str(count_time))
            instance = self.checkParameterisList(instance)
            print( "check type:" )
            #print( type(instance) )
            print("check content : ")
            print( instance )
            ...
            print("arguments_indices")
            print(argument_indices)
            argument_indices_offset = [idx + self.offset for idx in argument_indices]
            print("argument_indices_offset")
            print(argument_indices_offset)
            print("argument_indices_offset.length")
            print(len(argument_indices_offset))
            ...
            if self.mode in ["train"]:
                ...
                try:
                    ...
                    print( "value error!" )
                    print(instance["id"])
                    print(instance["question_passage"])
            ...
            """
            print( "DataBatchGenerator._init_data()运行" )
            print( "DataBatchGenerator._init_data() question_passage_ids:" )
            print( question_passage_ids ) 
            print( "DataBatchGenerator._init_data() question_index:" )
            print( question_index ) 
            print( "DataBatchGenerator._init_data() number_unit_graph_mask:" )
            print( number_unit_graph_mask )
            print( "DataBatchGenerator._init_data() number_indices_offset:" )
            print( number_indices_offset )
            print( "DataBatchGenerator._init_data() number_in_qp_mask:" )
            print( number_in_qp_mask )
            print( "DataBatchGenerator._init_data() golden_op_ids:" )
            print( golden_op_ids )
            print( "DataBatchGenerator._init_data() golden_argument_ids:" )
            print( golden_argument_ids )
            print( "DataBatchGenerator._init_data() units_idx:" )
            print( units_idx )
            print( "DataBatchGenerator._init_data() golden_sequence_program_ids:" )
            print( golden_sequence_program_ids )
            """
            print( "DataBatchGenerator._init_data() instance:" )
            print( instance )
            self.datas.append((question_passage_ids, 
                               ...
                               instance))
        print( "DataBatchGenerator._init_data()运行" )
        print( "DataBatchGenerator._init_data() self.datas:" )
        print( self.datas )  
    ...
    def convert_argu_to_ids(self,
                ...
                if argu in self.const_list:
                    ...
                    if self.data_name == "finqa":
                        try:
                            ...
                            print("len(arguments)")
                            print(len(arguments))
                            print("idx_for_indices:")
                            print(idx_for_indices)
                            print("arguments[idx_for_indices]")
                            print(arguments[idx_for_indices])
        ...
        print( "DataBatchGenerator.convert_argu_to_ids()运行" )
        print( "DataBatchGenerator.convert_argu_to_ids() golden_argument_ids:" )
        print( golden_argument_ids )
    ...
    def convert_op_argu_to_ids(self,
        ...
        print( "DataBatchGenerator.convert_op_argu_to_ids()运行" )
        print( "DataBatchGenerator.convert_op_argu_to_ids() golden_program_ids:" )
        print( golden_program_ids )
    ...
    def checkParameterisList(self, srcjson ):
        title = ['question_passage_tokens','tables','arguments','arguments_indices'
                 ,'number_indices','number_unit_graph','number_number_graph'
                 ,'golden_op','golden_argument']
        # print( type(title) )
        for t in title:
            tempqts = srcjson[t]
            if (str(type(tempqts)) != '<class \'list\'>'):
                print('type of element : \''+t+'\' error! start transform!')
                tempqts = json.loads(tempqts)
                # print('new type:='+str(type(tempqts)))
                del srcjson[t]
                srcjson[t] = tempqts
        # for t in title:
        #     tempqts = srcjson[t]
        #     print('type of element : \''+t+'\' type:='+str(type(tempqts)) )
        return srcjson

if __name__ == "__main__":
    from argparse import ArgumentParser
    #声明有哪些参数，包括用什么plm，train、dev、test数据集等
    ...
    # 给具体参数赋值，包括train、dev、test数据集路径等
