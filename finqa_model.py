...
#from .hierarchical_decoder_multiA_rawHsize import HierarchicalDecoder
from .hierarchical_decoder_recall_EnhanceMutiHead import HierarchicalDecoder
from .gnn import GNN
...
class FinQAModel(nn.Module):
    def __init__(self, args, op_list, const_list):
        ...
        if self.args.plm.startswith("roberta"):
            ...
            print( "self.args.plm"+str(self.args.plm) )
    ...
    def forward(self,
        ...
        # if decoder_input.shape != (3,512,1024):
        #     printAndLog("decoder_input.shape error!!!")
        #         printAndLog("encoder_outputslast_hidden_state=>decoder_input.shape:="+str(decoder_input.shape))
        #     decoder_input = torch.cat([decoder_input, decoder_input[:1, :, :]], dim=0)
        #     printAndLog("decoder_input.shape after repair:")
        #     printAndLog(str(decoder_input.shape))
